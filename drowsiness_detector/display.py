...
def draw_landmarks(frame, eye_pts_l, eye_pts_r, mouth_pts, ear, mar,
    ...
    eye_color   = RED if ear < ear_th  else GREEN
    mouth_color = RED if mar > mar_th   else GREEN
...
def draw_ui(frame, ear, mar, yaw, pitch, perclos, state, alerts_fired, fps,
    ...
    eye_cond      = (ear < ear_th) if eyes_closed is None else eyes_closed
